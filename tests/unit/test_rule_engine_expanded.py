...
def test_r2_sin_presencia_ni_senales():
    perfil = {"contribuyente_nit": "9003189639", "periodo": "2024"}
    result = evaluar_reglas(perfil, ["R2"])
    assert result == []
...
def test_r4_facturacion_cero():
    perfil = {"contribuyente_nit": "9003189639", "periodo": "2024", "facturacion_electronica": []}
    result = evaluar_reglas(perfil, ["R4"])
    assert result == []
...
def test_r5_sin_contratos():
    perfil = {"contribuyente_nit": "9003189639", "periodo": "2024", "contratos_publicos": []}
    result = evaluar_reglas(perfil, ["R5"])
    assert result == []
...
def test_r1_sin_retenciones():
    perfil = {"contribuyente_nit": "9003189639", "periodo": "2024", "retenciones_ica": []}
    result = evaluar_reglas(perfil, ["R1"])
    assert result == []
